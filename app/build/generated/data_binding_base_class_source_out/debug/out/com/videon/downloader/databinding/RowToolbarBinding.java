...
public final class RowToolbarBinding implements ViewBinding {
  ...
  private RowToolbarBinding(@NonNull LinearLayout rootView, @NonNull StatusBarView statusBar,
  ...
  @NonNull
  public static RowToolbarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowToolbarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_toolbar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowToolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowToolbarBinding((LinearLayout) rootView, statusBar, toolbarMain);
    }
